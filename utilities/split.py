...
make_data("tvt_train_label.csv","tvt_train",train_index,train_df)
make_data("tvt_val_label.csv","tvt_val",val_index,train_df)
make_data("tvt_test_label.csv","tvt_test",test_index,train_df)

train_df = make_iter_splits(7)
test_index = train_df[train_df['fold']==4].index.values
val_index = train_df[train_df['fold']==9].index.values
train_index = train_df[train_df['fold'].isin([0,1,2,3,5,6,7,8])].index.values

make_data("tvt_train_label2.csv","tvt_train2",train_index,train_df)
make_data("tvt_val_label2.csv","tvt_val2",val_index,train_df)
make_data("tvt_test_label2.csv","tvt_test2",test_index,train_df)
